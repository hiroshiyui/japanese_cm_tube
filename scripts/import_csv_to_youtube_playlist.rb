...
%w[YT_API_KEY YT_CLIENT_ID YT_CLIENT_SECRET].each do |yt_env_var|
  raise "Missing #{yt_env_var} environment variable!" if ENV[yt_env_var.to_s].nil?
end
...
begin
  ...
  playlist = account.create_playlist(title: title) if playlist.nil?
